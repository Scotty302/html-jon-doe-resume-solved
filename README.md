...
- [ x Waiting for new test files to get pushed through] All the tests MUST pass. Fix any errors before you submit (acceptance criteria).
  - [ x Waiting for new test files to get pushed through ] Use `npm run test` to run all tests in the terminal
  - [ x Waiting for new test files to get pushed through ] Use `npm run test-part1` to run the tests for the first part of specific requirements in the terminal
  - [ x Waiting for new test files to get pushed through ] Use `npm run test-part2` to run the tests for the second part of specific requirements in the terminal
  - [ x Waiting for new test files to get pushed through ] (Optional) Use `npm run test-ui` to run all the tests with GUI
  - [ x Waiting for new test files to get pushed through ] (Optional) Use `npm run show-report` to see the latest report in the browser
